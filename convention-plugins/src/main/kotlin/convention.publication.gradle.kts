...
publishing {
    ...
    publications.withType<MavenPublication> {
        ...
        pom {
            ...
            url.set("https://github.com/Hukumister/Gemini")
            ...
            scm {
                developerConnection.set("scm:git@github.com:Hukumister/Gemini.git")
                connection.set("scm:git:git://github.com/Hukumister/Gemini")
                url.set("https://github.com/Hukumister/Gemini")
            }
        }
    }
